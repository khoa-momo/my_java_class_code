...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        do {
            MenuFile();    
            int choosefile = ValidateInput.inputInt("Enter file option: ", "Choose from 1 to 3 only!", 1, 3);
            switch (choosefile){
                //BOOK FILE
                case 1:
                    while (true){
                    ...
                    while (true){
                        ...
                        switch (choice3){
                            ...
                            case 3:
                                ...
                                break;          
                            case 4:
                                manager3.saveFile(fname3);
                                System.out.println("Lending information has been save file!");
                                System.out.println();
                            case 5:
                                System.out.println("Thank you for using our service!");
                                System.exit(0); 
