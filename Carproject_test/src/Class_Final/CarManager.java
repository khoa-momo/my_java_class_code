...
public class CarManager {
    ...
    //Main program
        ...
        boolean a = brandList.loadFromFile("1.txt");
        
        CarList carList = new CarList(brandList);
        boolean b = carList.loadFromFile("2.txt");        
        ...
        do{ 
            ...
            switch (choice){
                ...
                case 9:
                    ...
                    break; 
                case 10:
                    boolean update = carList.updateCar();
                    if(update == true){
                    ...
                    break; 
                case 11:
                    boolean d = brandList.saveToFile("File brands.txt");
                    if(d == true){
                        System.out.println("File save successfully.");
                        System.out.println("");
                    }else{
