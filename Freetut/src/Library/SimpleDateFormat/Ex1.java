 ...
 */
package Library.SimpleDateFormat;
...
//Trong Java, SimpleDateFormat được dùng để định dạng cách hiển thị ngày tháng. Để sử dụng được SimpleDateFormat, 
//chúng ta cần phải import gói thư viện java.text.SimpleDateFormat của Java. Cú pháp import như sau:    
