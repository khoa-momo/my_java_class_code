...
public class GUI {
    ...
    public static void f1(StudentManager va, StudentManager sl) throws IOException{
        // Setup
        Scanner sc = new Scanner(System.in);
        Validation ul = new Validation();
        
        // In subjects.txt -> no change
        String file = "subjects.txt"; 
        System.out.println("\nList of subjects:"); 
        System.out.println("ID\t\tName");
        
        va.loadfromfile(file, sl, "");          ////////////METHOD loadfromfile subjects
        System.out.print("\n"); 
        
        // Nhap subject ID va kiem tra
        String a;
        do{
            a = ul.getString(sc, "subject ID", "^[A-Z]{3}[0-9]{3}", true);              ////////////METHOD
        }while (!va.find(a, file, sl, "", ""));
        
        // In exercise.txt + total. Can phai khoi tao lai bien sl thi thay file
        file = "exercises.txt";
        sl = new StudentManager();
        System.out.println("\nList of exercises of subject " + a + ":");
        //
        System.out.println("Name\t\tPercentage");
        va.loadfromfile(file, sl, a);                                                ////////////METHOD loadfromfile exercises
        
        System.out.println("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
        System.out.format("Total\t\t%.2f\n\n", va.total(sl, a));                           ////////////METHOD 
        ...
        StudentAtt st = new StudentAtt(a, b, c);
    ...
    public static void f2(StudentManager va, StudentManager sl) throws IOException{
        //Setup
        Scanner sc = new Scanner(System.in);
        Validation ul = new Validation();
        ...
        StudentAtt student = new StudentAtt(id, a, lab, mak);
        for (int i = 0; i < sl.size(); i++)
        {
